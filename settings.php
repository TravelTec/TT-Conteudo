...
date_default_timezone_set('America/Sao_Paulo');
                    ...
                    <div id="tab-config" class="tab-content" style="padding: 20px 10px">
                        ...
                        <p style="font-size:17px;line-height: 1.8">Após incluir a licença, o plugin irá validar a licença e iniciar a importação diária do conteúdo. Você também tem a opção de importar todo o conteúdo que já está publicado na base de dados da Travel Tec.</p>
